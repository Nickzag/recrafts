...
const request = { protocol_version: "1.0", request_id: "package-smoke", operation: "capabilities", host: { agent: "package-smoke", engine: "node", capabilities: [] }, working_root: root, input: {} };
