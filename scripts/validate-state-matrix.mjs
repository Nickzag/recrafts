...
import { validateStateMatrix } from "../runtime/product_ui_contract.mjs";
...
const errors = validateStateMatrix(await read("state-matrix.json"), new Set(evidence.evidence.map((item) => item.evidence_id)));
