...
const realized = run(base("generate-realization", { package_directory: "package" }, "realization")); checks.push({ name: "generate-realization", passed: realized.exit_code === 0 && realized.response?.validation.realization_id });
