...
import { validateComponentRecurrence } from "../runtime/product_ui_contract.mjs";
...
const errors = validateComponentRecurrence(components.contracts, components.recurrence, new Set(evidence.evidence.map((item) => item.evidence_id)));
