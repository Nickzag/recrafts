...
import { validateProductUISourceScope } from "../runtime/product_ui_contract.mjs";
...
const errors = validateProductUISourceScope(await read("source-scope-map.json"), new Set(evidence.evidence.map((item) => item.evidence_id)));
