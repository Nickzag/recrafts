    ...
    for (const [name, viewport] of Object.entries(VIEWPORTS)) {
      ...
      allComputed[name] = await page.evaluate(() => {
          ...
          return {
            ...
            regions: [...document.querySelectorAll("[data-recrafts-region]")].map((el, idx) => { const comp = el.closest("[data-recrafts-composition]"); return { id: el.getAttribute("data-recrafts-region"), composition_id: comp ? comp.getAttribute("data-recrafts-composition") : null, visibility: el.getAttribute("data-recrafts-visibility"), display: getComputedStyle(el).display, order: idx }; })
          };
        });
    }
  } finally {
