...
const sourceArtifacts = {
  ...
  reconstruction: { schema: "recrafts.faithful-reconstruction/v1", candidate_revision: "C-FIXTURE-1", design_sha256: designSha, region_set_sha256: null, surfaces: [{ region_id: "RG1", status: "rendered" }] },
  comparison_report: { schema: "recrafts.source-comparison/v1", candidate_revision: "C-FIXTURE-1", reconstruction_sha256: null, comparisons: [{ region_id: "RG1", visual_similarity: 0.97, unsupported_objects: [], unknowns_hardened: false }] },
  geometry_report: { schema: "recrafts.geometry-report/v1", candidate_revision: "C-FIXTURE-1", region_set_sha256: null, measurement_set_sha256: null, regions: [{ region_id: "RG1", delta_px: 1, tolerance_px: 2 }] }
};
...
const gateB = evaluateDesignCoherence({ candidate, designSource, previewHtml: preview.html });
