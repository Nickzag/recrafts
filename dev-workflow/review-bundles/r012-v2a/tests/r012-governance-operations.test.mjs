...
test("Owner import, Release creation/validation, and rollback execute through public Operations", async () => {
  ...
  const created = await executeDesignOperation({ operation: "create-design-release", input: { design_store_directory: "design-store", candidate_file: "candidate.json", design_file: "design.md", gate_a_report_file: "gate-a.json", gate_b_report_file: "gate-b.json", owner_decision_receipt_file: "decision-import/owner-decision-receipt.json", release_id: "R1", version: "0.1.0", parent_release_id: null } }, root);
