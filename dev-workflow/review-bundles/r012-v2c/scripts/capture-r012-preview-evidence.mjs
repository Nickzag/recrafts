...
export async function capturePreviewEvidence({ previewFile, outputDirectory }) {
  ...
  const evidence = {
    schema: "recrafts.preview-browser-evidence/v1", status: computedStyles.infrastructure_selector_audit === "PASS" ? "PASS" : "FAIL",
    preview_sha256: sha256(await readFile(previewFile)), browser_engine: "playwright-chromium", screenshots,
    computed_styles: { root_tokens: computedStyles.root_tokens, specimen: computedStyles.specimen, visual_region: computedStyles.visual_region },
    infrastructure_selector_audit: computedStyles.infrastructure_selector_audit,
    infrastructure_affects_visual_region: computedStyles.infrastructure_selector_audit !== "PASS"
  };
