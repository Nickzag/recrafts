...
export async function runInstalledConsumerSmoke({ workspace, cliFile, packageRoot }) {
  ...
  execute("validate-design", { design_file: "design.md", candidate_file: "candidate.json", preview_file: "preview-output/preview.html" }, "completed");
  execute("compare-design-candidates", { candidates_file: "candidates.json" }, "completed");
  ...
  const order = ["parse-design-md", "compile-design-ir", "validate-design", "render-design-preview", "compare-design-candidates", "import-design-owner-decision", "create-design-release", "validate-design-release", "rollback-design-release", "compare-design-releases"];
