...
test("Gate B proves Design coherence but explicitly cannot prove Source Fidelity", async () => {
  ...
  const report = await governance.evaluateDesignCoherence({ candidate, designSource: canonical, previewHtml: preview.html });
