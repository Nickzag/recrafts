...
export async function gateReports({ candidate, designSource = canonical } = {}) {
  ...
  const gateB = await evaluateDesignCoherence({ candidate, designSource, previewHtml: preview.html, browserEvidence: { status: "PASS", preview_sha256: sha(designSource), screenshots: { desktop: { file: "desktop.png", sha256: "0".repeat(64) }, compact: { file: "compact.png", sha256: "0".repeat(64) }, mobile: { file: "mobile.png", sha256: "0".repeat(64) } }, computed_styles: { root_tokens: {} }, _evidence_dir: process.cwd(), evidence_sha256: sha(JSON.stringify({ status: "PASS" })) } });
  const gateABase = {
