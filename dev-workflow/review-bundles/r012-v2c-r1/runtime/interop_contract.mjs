...
const protocol12Operations = new Set(["prepare-visual-recovery", "submit-visual-observations", "generate-faithful-reconstruction", "verify-source-fidelity", "compile-portable-product-ui", "generate-target-adaptation", "parse-design-md", "compile-design-ir", "validate-design", "render-design-preview", "compare-design-candidates", "import-design-owner-decision", "create-design-release", "validate-design-release", "rollback-design-release", "compare-design-releases"]);
...
function assertRequest(request) {
  ...
  if (request?.protocol_version !== "1.2" && protocol12Operations.has(request?.operation)) throw Object.assign(new Error("This operation requires protocol 1.2"), { code: "PROTOCOL_VERSION_UNSUPPORTED" });
