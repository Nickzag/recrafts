...
export type IntelligenceStatus = "PASS" | "DEGRADED" | "BLOCK";
export type MeasurementClass = "OBSERVED_EXACT" | "OBSERVED_RANGE" | "DERIVED_ROLE" | "IMPLEMENTATION_CANDIDATE" | "UNKNOWN";
export type ComponentMaturity = "M0" | "M1" | "M2" | "M3" | "M4" | "M5";
export interface DownstreamUtilityResult { schema: "recrafts.downstream-utility-result/v1"; consumer_class: string; verdict: IntelligenceStatus; gaps: string[]; invention_required: boolean }
